...
// Schedule the task status updater once DB is ready. If DB isn't ready yet,
// poll until `global.DB_READY` becomes true to avoid connection errors on startup.
const scheduleUpdateOverdueTasks = () => {
    cron.schedule('*/30 * * * *', () => {
